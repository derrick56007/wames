use crate::{components::{get_item_char, Component, Item, Position}, entity::{new_entity, Entity}, event::{Event, }, sight::ViewType};
...
pub fn create_dialogue(entity_id_counter: &mut usize, dialogue: String, options: Vec<(String, Event)>, pos: Position) -> Entity {
